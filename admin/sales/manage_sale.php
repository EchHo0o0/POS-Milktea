...
<div class="content py-3">
    <div class="container-fluid">
            ...
            <div class="card-body">
                <div class="container-fluid">
                    <form action="" id="sale-form">
                        ...
                        <div class="border rounded-0 shadow bg-gradient-black px-1 py-1" id="sales-panel">
        ...
        .prod-item {
            ...
            padding: 5px 5px;
            background-color:rgb(252, 52, 7); /* Light gray background */
            border: 1px solid #ddd;
            border-radius: 0px; /* Rounded-pill effect */
            text-align: center;
            color: #333; /* Text dark color */
        ...
        /* Hover effect */
        .prod-item:hover {
            background-color:#edafd0; /* Blue background */
            color: #fff; /* White text */
            transform: translateY(-5px); /* Subtle lift effect */
            box-shadow: 0 4px 10px hsla(0, 87.30%, 50.80%, 0.90); /* Shadow effect */
        }
    </style>
