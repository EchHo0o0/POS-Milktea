<style>
  ...
  .navbar.navbar-expand-md.navbar-light.navbar-pink {
  ...
  .navbar-nav .nav-item.dropdown .nav-link.dropdown-toggle {
    color: #6D4F29; /* Dark brown color for dropdown toggle */
  }
  ...
  .dropdown-submenu .dropdown-item {
    color: #6D4F29; /* Dark brown color for level 2 dropdown items */
  }
  ...
  .badge-danger {
    background-color: #C7A17A; /* Badge color for messages */
  }

  .badge-warning {
    background-color: #F3E5AB; /* Badge color for notifications */
  }

  .navbar-toggler-icon {
    background-color: #6D4F29; /* Dark brown color for toggler icon */
  }

  .navbar-brand .brand-text {
    color: #6D4F29; /* Dark brown for brand name text */
  }

  .navbar-brand .brand-image {
    opacity: 1; /* Make logo slightly clearer */
  }

  /* Search Form */
  .form-control-navbar {
    background-color: #F3E5AB; /* Light Milk Tea color for search input */
    color: #6D4F29; /* Dark brown text for search input */
  }

  .form-control-navbar::placeholder {
    color: #6D4F29; /* Dark brown placeholder text */
  }

  .btn-navbar {
    background-color: #C7A17A; /* Milk Tea brown for search button */
    color: #fff;
  }
